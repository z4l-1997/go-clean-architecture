...
-- INDEXES SUMMARY
-- ===========================================
-- users: idx_username, idx_email, idx_role, idx_is_active
-- khach_hang: idx_user_id, idx_so_dien_thoai, idx_cap_thanh_vien, idx_diem_tich_luy
-- nhan_vien: idx_user_id, idx_chuc_vu, idx_trang_thai, idx_chuc_vu_trang_thai
